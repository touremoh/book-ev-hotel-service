...
@RequestParamsMapper
public class MailingListRequestParamsMapper implements BookEVHotelRequestParamsMapper<MailingListDTO> {
	@Override
	public MailingListDTO map(Map<String, String> params) throws BookEVHotelException {
