...
import com.bookevhotel.core.mapper.JwtMapper;
...
public class OAuth2TokenService {
    ...
    public String getAccessToken() throws BookEVHotelException {
        try {
            if (tokenNotExpired()) {
            ...
            throw new BookEVHotelException("Failed to retrieve OAuth2 token", e, HttpStatus.INTERNAL_SERVER_ERROR.value(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    private String refreshToken() throws BookEVHotelException {
        try {
